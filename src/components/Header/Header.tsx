...
export const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur p-2 pr-7 supports-[backdrop-filter]:bg-background/60">
            <div className="container mx-auto flex h-16 items-center justify-between px-4">

                <Link to={"/"} className="flex items-center gap-2">
                    <Umbrella className={clsx("size-14", isDark ? "text-yellow-500" : "text-blue-500")} />
                    <p>
                        <span className="text-2xl font-bold text-yellow-500 sm:hidden">D</span>
                        <span className="hidden text-2xl font-bold text-yellow-500 sm:inline">DXNCAT</span>
